...
// Form options
$options['captcha_secret']   = '6LfMoRATAAAAAJXOdCNoYpI73JD4ZzpT2gqIWdtq';                     // Google reCAPTCHA secret key
...
$options['from_address']     = 'scanlanjewelers1903@gmail.com';               // Address the email is sent from
$options['from_name']        = 'Scanlan Jewelry';                              // Name to attach to the address
$options['to_addresses']     = array( 'scanlanjewelers1903@gmail.com' );               // To: addresse(s), add new array item for more
